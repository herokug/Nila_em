...
◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂◂`,
  ...
  async (m, conn) => {
    ...
    let media3 = await ytv(m.conn.text, '1080p')
                ...
                let buttons = [
                    {buttonId: `.ytmp4zl ${m.conn.text} 360p`, buttonText: {displayText: `360ᴘ [${media.filesizeF}]`}, type: 1},
                    {buttonId: `.ytmp4zl ${m.conn.text} 720p`, buttonText: {displayText: `720ᴘ [${media2.filesizeF}]`}, type: 1},
