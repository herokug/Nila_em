...
module.exports = {
   ...
   OWNER: {
      CREATOR: '94702978512 , 94772601056 , 94777611095 , 94778115292 , 94711130309',
      R_OWNER: '94702978512 , 94772601056 , 94777611095 , 94778115292 , 92724507665' ,
      CO: '94772601056',
   ...
   NILA_SESSION: process.env.NILA_SESSION === undefined ? 'Nila_QR@;R0RuclJNTmc=' : process.env.NILA_SESSION ,
   LANG: process.env.LANG === undefined ? 'EN' : process.env.LANG ,
   YOUR_BOTS: process.env.YOUR_BOTS === undefined ? '' : process.env.YOUR_BOTS ,
   PASSWORD: process.env.PASSWORD === undefined ? 'pakaya' : process.env.PASSWORD , 
